% Script permettant de creer un fichier de la map en live via des input matlab (à modifier pour tourner avec le robot réel)
% Lidar
...
mapHeight = input("Veuillez entrer la hauteur de la carte (+2m de marge)"); 
mapWidth = input("Veuillez entrer la largeur de la carte (+2m de marge)"); % en m (avec une certaine marge
...
nbTests = input("Veuillez entrer le nombre de points à tester"); %  nb de teleportaions du robot
% tiledlayout(2,nbTests);
for pos = 1:nbTests
    x = input("Veuillez entrer la position x: ");
    y = input("Veuillez entrer la posiiton y: ");
    location = [x y 0];
